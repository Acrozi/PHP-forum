...
class Category {
	...
	public function listCategory(){
		...
		while ($category = $result->fetch_assoc()) {
			...
			$rows[] = '<button type="button" name="update" id="'.$category["category_id"].'" class="btn btn-warning btn-xs update"><span class="glyphicon glyphicon-edit" title="Ändra"></span></button>';
			$rows[] = '<button type="button" name="delete" id="'.$category["category_id"].'" class="btn btn-danger btn-xs delete" ><span class="glyphicon glyphicon-remove" title="Ta bort"></span></button>';
			$records[] = $rows;
		}
